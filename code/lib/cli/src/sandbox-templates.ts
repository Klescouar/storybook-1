...
export const yarnTemplates = {
  'angular-cli-yarn/default-ts': {
    ...
    script:
      'yarn dlx -p @angular/cli ng new angular-latest --directory {{beforeDir}} --routing=true --minimal=true --style=scss --strict --skip-git --package-manager=yarn --skip-install && cd {{beforeDir}} && yarn set version berry && yarn config set nodeLinker node-modules && yarn',
  },
  'lit-vite-yarn/default-ts': {
    ...
    inDevelopment: true,
    script:
      'yarn create vite {{beforeDir}} --yes --template lit-ts && cd {{beforeDir}} && yarn set version berry && yarn',
  },
  'vue3-vite-yarn/default-ts': {
    ...
    // enable node-linker mode and deactivate pnp mode since it is not supported
    script:
      'yarn create vite {{beforeDir}} --yes --template vue-ts && cd {{beforeDir}} && yarn set version berry && yarn config set nodeLinker node-modules && yarn',
  },
  'react-vite-yarn/default-ts': {
    ...
    inDevelopment: true,
    script:
      'yarn create vite {{beforeDir}} --yes --template react-ts && cd {{beforeDir}} && yarn set version berry && yarn',
  },
  'nextjs-yarn/default-ts': {
    ...
    inDevelopment: true,
    script:
      'yarn create next-app {{beforeDir}} --typescript --eslint --tailwind --app --import-alias="@/*" --src-dir --use-yarn && cd {{beforeDir}} && yarn set version berry && yarn',
  },
} satisfies Record<string, Template>;
